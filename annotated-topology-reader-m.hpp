...
#ifndef __ANNOTATED_TOPOLOGY_READER_H_M__
#define __ANNOTATED_TOPOLOGY_READER_H_M__
 ...
 *
 */
class AnnotatedTopologyReaderM : public TopologyReader {
public:
  /**
   * \brief Constructor
   *
   ...
   * \see ns3::Names class
   */
  AnnotatedTopologyReaderM(const std::string& path = "", double scale = 1.0);
  virtual ~AnnotatedTopologyReaderM();
...
private:
  AnnotatedTopologyReaderM(const AnnotatedTopologyReaderM&);
  AnnotatedTopologyReaderM&
  operator=(const AnnotatedTopologyReaderM&);
