...
namespace nfd {
    namespace fw {
        ...
        class BestRouteStrategy2WithPitLimit
            : public Strategy
            , public ProcessNackTraits<BestRouteStrategy2WithPitLimit> {
        public:
            explicit
                BestRouteStrategy2WithPitLimit(Forwarder& forwarder, const Name& name = getStrategyName());
        ...
        private:
            ...
            friend ProcessNackTraits<BestRouteStrategy2WithPitLimit>;
        };
    } 
} 
#endif
